...
public class NYTClient {
    ...
    public void search(Context context, String query, JsonHttpResponseHandler handler) {
        RequestParams params = buildRequest(context, query);
        client.get(API_BASE_URL, params, handler);
    }

    private RequestParams buildRequest(Context context, String query) {
